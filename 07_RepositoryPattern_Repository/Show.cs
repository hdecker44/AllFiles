...
namespace _07_RepositoryPattern_Repository
{
    ...
    {
        public Show() { }
        public Show(string genre, string title, int starRating, StreamingQualityType typeOfQuality, string description, Language typeOfLanguage, MaturityRating typeOfMaturityRating, List<Episode> episodes)
